...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("MSTCDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["203.81.84.93"];
pub const RS_PUB_KEY: &str = "gEIFyeXWLASDgOzQxsYbY8jOxA2RfAPhujXnS0zvIvQ=";
